...
export default function MapPanel() {
  ...
  return (
    <div className="relative h-full w-full bg-gray-700 backdrop-blur-xl rounded-3xl p-4 border border-white/20 shadow-2xl flex flex-col">
      ...
      <div
        id="map"
        className="flex-1 w-full min-h-[500px] rounded-2xl overflow-hidden shadow-2xl"
      />
    </div>
  );
}
