...
export default function DirectionsSteps({ directionsResult, onStepSelect }) {
  ...
  return (
    <div className="max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-blue-900/50 rounded-2xl p-4 bg-white/10 backdrop-blur-sm border border-white/20">
